...
if ($_FILES['file']['size'] > $maxSize) {
    AppController::createMessage(AppController::FILE_ERROR_MESSAAGE, 413);
}
...
if (!in_array($mimeType, $allowedMimeTypes)) {
    AppController::createMessage(AppController::FILE_ERROR_MESSAAGE, 415);
}
...
// Ako je prosleđena stara slika, pokušaj da je obrišeš
if (!empty($_POST['oldFile'])) {
   AppController::deleteUserImage($_POST['oldFile']);
}
